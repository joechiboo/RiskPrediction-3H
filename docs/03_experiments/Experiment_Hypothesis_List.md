...
**假說**：精簡特徵（如只用前 5 個重要特徵）能維持 90% 以上的預測效能。

**背景**：
- 目前使用 10+ 個特徵，但臨床應用時特徵越少越實用
- 參考 SHAP 分析結果選擇最重要特徵
...
|-------|---------|---------|
| 全部（10+） | Baseline | 100% |
| Top 5 | SHAP importance | ≥90%? |
| Top 3 | SHAP importance | ≥80%? |

**評估標準**：
- 若 Top 5 能達到 Baseline 的 90%，則可建議臨床簡化版
- 比較不同疾病的「最小必要特徵集」
...
**假說**：已有一種三高的人，預測另外兩種的準確度更高（或風險更高）。

**背景**：
- 三高常有共病現象（如高血壓患者更容易有高血脂）
- 共病可能提供額外預測訊號

**可能的研究方向**（待確定）：

1. **預測難度角度**
   - 已有一種三高 → 預測「新發」另一種是否更準？
   - 還是反而更難（因為已有疾病干擾）？

2. **風險倍增角度**
   - 已有高血壓 → 發生高血糖的風險是一般人的幾倍？
   - 三高之間的 Odds Ratio / Hazard Ratio

3. **特徵重要性角度**
   - 對「已有高血壓」的人，預測高血糖時哪些特徵最重要？
   - 與「無高血壓」的人相比，特徵重要性是否不同？

4. **疾病進展順序**
   - 三高的發病順序有規律嗎？（如：高血脂 → 高血壓 → 高血糖）
   - 哪種「先發疾病」對後續風險影響最大？
