...
| 23_PySR_SlidingWindow | PySR 滑動窗口版本 | 🔄 待執行 |
...
| 項目 | 內容 |
|------|------|
| **假說** | PySR 在滑動窗口資料上可產生更穩定的公式 |
| **狀態** | 🔄 Notebook 已建立，待執行 |
| **Notebook** | [23_PySR_SlidingWindow.ipynb](../../notebooks/experiments/23_PySR_SlidingWindow.ipynb) |
| **設計** | 5-Fold StratifiedGroupKFold，使用 Nb16 最佳參數 |
| **預估時間** | 1-2 小時（3疾病 × 5 folds × 10分鐘）|

---

## 📋 待執行實驗

### E14. Calibration Curves + DCA
...
| 項目 | 內容 |
|------|------|
| **假說** | CatBoost 可能比 XGBoost 表現更好 |
| **優先度** | 低 |
| **參考** | JMIR 2025：CatBoost > LightGBM > XGBoost |
