...
|:----:|:--------:|:------:|:-----|:-----------:|
| 高血壓 | 0.580 ±0.110 | ❌ 3/5 常數 | `0.09*SBP_T2 + 0.19` | 0.721 |
| **高血糖** | **0.918 ±0.016** | ✅ 5/5 穩定 | `0.12*FBG_T2` | 0.938 |
| 高血脂 | 0.640 ±0.192 | ❌ 3/5 常數 | `0.09*TC_T2 + 0.08` | 0.867 |
...
| 發現 | 說明 |
|:-----|:-----|
| 高血糖公式穩定 | 5/5 fold 都產出 `0.12*FBG_T2`，AUC=0.918 接近 LR |
