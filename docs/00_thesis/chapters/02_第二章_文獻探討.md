...
| Dinh et al.<br>(2019) | 糖尿病 | NHANES | 21,131 | XGBoost | 0.862 | 無 | Info. Gain |
...
註：Ye、Alaa、Kanegae、Liu、Wang、Yang 及本研究為縱向研究設計；Dinh、Hung、Majcherek 為橫斷面研究。
...
2. **變化量特徵的系統性驗證**：雖然 Yang et al. (2025) 和 Kanegae et al. (2020) 證明 Δ 特徵有效，但僅針對單一疾病，缺乏跨疾病的驗證
