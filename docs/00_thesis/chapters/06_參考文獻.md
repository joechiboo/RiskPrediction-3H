...
<!-- TODO: 待確認 #11 — DOI 對應到 Yang, C.-C. et al. 而非 Chen；需確認論文中引用的是哪一篇 -->
Chen, Y., et al. (2025). A dual-framework approach combining SHAP and δ-FPG for prediabetes screening and interpretation. *Diagnostics*, *15*(19), 2507. https://doi.org/10.3390/diagnostics15192507
...
Jacobs, M. J., et al. (2005). Coronary heart disease risk factors, metabolic syndrome and hypertension. *Current Opinion in Cardiology*, *20*(4), 270–274. https://doi.org/10.1097/01.hco.0000166596.22836.07
...
<!-- TODO: 待確認 #28 — DOI 10.3390/jcdd10010020 對應到 SCUBA 潛水論文（Kauling et al.），非 Patti；網路搜尋找不到此篇，需確認是否存在或應替換 -->
Patti, A. M., et al. (2023). Links between metabolic syndrome and hypertension. *Journal of Cardiovascular Development and Disease*, *10*(1), 20.
...
*備註：本文獻清單共 31 筆（英文 29 筆、中文 2 筆），依 APA 第七版格式排列。標記 TODO 的 2 筆（#11 Chen、#28 Patti）待人工確認後補完。Jacobs et al. 作者全名待核實。*
