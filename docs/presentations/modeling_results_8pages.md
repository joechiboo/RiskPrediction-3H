...
- **高血壓**: SBP ≥ 140 或 DBP ≥ 90
- **高血糖**: FBG ≥ 100 mg/dL
- **高血脂**: TC ≥ 200 mg/dL

### 📊 特徵設計 (26個)
**時間點**: T1 (基線) → T2 (追蹤) → T3 (預測)
...
研究目標是預測第三次檢查時是否罹患三高。我們設計了26個特徵,包括人口統計、兩個時間點的生物標記,最重要的創新是加入Delta變化量特徵,捕捉T1到T2的健康變化趨勢。類別不平衡是主要挑戰,高血壓約17%,高血糖和高血脂只有6%左右。
