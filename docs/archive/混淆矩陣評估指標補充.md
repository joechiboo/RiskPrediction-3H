...
| 指標 | 公式 | 意義 | 目前有無 |
|------|------|------|:--------:|
| **AUC (ROC-AUC)** | ROC 曲線下面積 | 整體區分能力 | ✅ 有 |
| **Precision** | TP / (TP+FP) | 預測為正的準確率 | ✅ 有 |
...
| 指標 | 公式 | 何時使用 |
|------|------|----------|
| **Accuracy** | (TP+TN) / Total | 參考用（不平衡資料會誤導） |
| **PR-AUC** | PR 曲線下面積 | SMOTE/class_weight 實驗 |
| **混淆矩陣** | TP, TN, FP, FN | 主要模型詳細分析 |
